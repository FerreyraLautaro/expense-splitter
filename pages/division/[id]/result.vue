  ...
  <div class="page result-page">
    <div class="container">
      <header class="result-header fade-up">
        <NuxtLink :to="`/division/${route.params.id}`" class="back-link muted">
          ← volver
        </NuxtLink>
      ...
      <template v-else>
        ...
        <div class="result-actions fade-up">
          <NuxtLink :to="`/division/${route.params.id}`" class="btn btn-ghost">← Editar</NuxtLink>
          <NuxtLink to="/" class="btn btn-primary">Nueva división →</NuxtLink>
        </div>
      </template>
    </div>
  </div>
